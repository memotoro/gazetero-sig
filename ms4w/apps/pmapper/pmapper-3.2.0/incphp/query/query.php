...
{ 
    ...
    function Query($map)
    {
        ...
        $wmsl = new WMS_Client($map, false, true);
    ...
    function printFieldValues($fldName, $fldValue)
    {
        ...
        */
        ...
        //ALE modifications for support of carriage return 
    ...
    function q_execAttributeQuery()
    {
        ...
        if (isset($_REQUEST['externalSearchDefinition'])) {
            ...
            $this->qLayerType = $_REQUEST['layerType'];
        ...
        // Defdault using search.xml definitions
        } else {
    ...
    function q_printAttributeQuery()
    {
        ...
        if ($this->numResultsTotal > 0) $this->printGrpResString($this->grp);
