 ...
 * by Armin Burger
 */
function scalebar_init() {
    pm_scaleBar = new ScaleBar(1);
    pm_scaleBar.divisions = 3;
    pm_scaleBar.subdivisions = 2;
    pm_scaleBar.resolution = 96;
    pm_scaleBar.minWidth = 160;
    pm_scaleBar.maxWidth = 220;
    pm_scaleBar.abbreviateLabel = true;
    pm_scaleBar.place('scalebar');
    pm_scaleBar.update(PMap.s1);
    $("#scalebar").showv();
